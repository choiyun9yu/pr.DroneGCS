...
const Btn = (props) => {
    ...
    const handleIsMissionAlt = () => {
        setIsMissionAlt(!isMissionAlt);
    }
    ...
    return (
        <>
            ...
            {isMissionAlt
                ? (<div className={`flex flex-row rounded border justify-end items-center text-sm`} style={{
                    position: 'absolute',
                    top: '195px',
                    left: '52px',
                    width: '135px',
                    ...
                    <div className={`mx-auto`}> {droneMessage && droneState.DroneMission.MissionAlt}</div>
                    <div className={`flex flex-col items-center text-xs`}>
                        <button className={`w-[40px] rounded-xl border hover:bg-[#AEABE9]`}
                                onClick={handleMissionAltUpBtn}>up
                        </button>
                        <button className={`w-[40px] rounded-xl border hover:bg-[#AEABE9]`}
                                onClick={handleMissionAltDownBtn}>down
                        </button>
                    </div>
                    {isXTen
                        ? <button className={`w-[30px] h-[36px] mr-1 rounded-xl border text-xs bg-[#AEABE9]`}
