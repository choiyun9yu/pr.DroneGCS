...
const VideoModeTop = () => {
    return (
        <div className={`flex items-start w-full h-1/2 mb-3 rounded-2xl bg-${ColorThema.Secondary4}`}>
...
const VideoModeBottom = () => {
    return (
        <div className={`flex items-start w-full h-1/2 rounded-2xl bg-${ColorThema.Secondary4}`}>
            <div className="flex flex-col w-full h-full m-2">
