    ...
    return (
        <>
            <div className={`absolute flex flex-col justify-around items-center left-[10px] top-[95px] w-[60px] h-[35%] text-xs rounded bg-white opacity-75`}>
                ...
                <button className={`flex flex-col items-center`} onClick={() => handleTakeoffBtn()}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
            ...
            {isCenterBtn
                ?(
                    <div className={`flex p-2 flex-col items-start rounded-md`} style={{
                        ...
                        <button className={`px-1 w-full rounded border border-gray-700`} onClick={handleCurrentCenter}>
                            Drone</button>
                        <button className={`px-1 my-1 w-full rounded border border-gray-700`} onClick={handleStartPointCenter}>
                            Start Point</button>
                        <button className={`px-1 w-full rounded border border-gray-700`} onClick={handleTargetPointCenter}>
                            Target Point</button>
                    </div>
                )
                : null}
