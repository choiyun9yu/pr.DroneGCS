                            ...
                            <div className={`flex flex-col px-2 mr-2`}>
                                <div className={`flex flex-row justify-end`}>
                                    <button
                                        ...
                                        className={`flex px-1 rounded-xl border hover:${ColorThema.Primary1}`}>
                                        현재 위치
                                    </button>
                                    ...
                                    {props.isLocalMarker
                                        ? (<button
                                            ...
                                            className={`flex mx-2 px-1 rounded-xl border ${ColorThema.Primary1}`}>
                                            마커 위치
                                        </button>)
                                        : (<button
                                            onClick={handleIsLocalMarker} type={`button`}
                                            className={`flex mx-2  px-1 rounded-xl border hover:${ColorThema.Primary1}`}>
                                            마커 위치
                                        </button>)
                                    }
                                ...
                                <div className={`flex justify-end mt-2`}>
                                    <button className={`flex px-2 rounded-xl border hover:${ColorThema.Primary1}`}>
                                        추가
                                    </button>
                                </div>
                            </div>
                        ...
                        <form id={`waypointdelete`} className={`mt-3`}
                            ...
                            <div className={`flex flex-row justify-end px-2 m-2`}>
                                ...
                                <div className={`flex items-end ml-3`}>
                                    <button
                                        className={`flex px-2 mb-0.5 rounded-xl border hover:${ColorThema.Primary1}`}>
                                        삭제
                                    </button>
                                </div>
                            </div>
            ...
            {isCenterBtn
                ? (
                    <div className={`flex p-2 flex-col items-start rounded-md`} style={{
                        ...
                        <button className={`px-1 w-full rounded border border-gray-700 hover:${ColorThema.Primary2}`}
                                onClick={handleCurrentCenter}>
                            Drone
                        </button>
                        <button className={`px-1 my-1 w-full rounded border border-gray-700 hover:${ColorThema.Primary2}`}
                                onClick={handleStartPointCenter}>
                            Start Point</button>
                        <button className={`px-1 w-full rounded border border-gray-700 hover:${ColorThema.Primary2}`} onClick={handleTargetPointCenter}>
                            Target Point</button>
                    </div>
                )
                : null}
