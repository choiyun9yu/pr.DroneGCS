            ...
            <div className="flex  flex-col w-full h-full ">
                <div className={`flex flex-col w-full h-full  p-3 mb-4 rounded-2xl bg-${ColorThema.Secondary4}`}>
                    ...
                    <div className="flex flex-row justify-around h-full p-5">
                        <div className={`flex flex-col justify-around mr-4 w-full  h-full rounded-md bg-${ColorThema.Secondary2}`}>
                            ...
                            <span className={`mx-auto font-extrabold text-2xl ${WarningData.xgyro_RAW_IMU?`text-${ColorThema.Semantic3}`:'text-[#FFFF00]'}`}>{(SensorData.xgyro_RAW_IMU)}</span>
                            <span className="mx-auto">{(RangeMin.xgyro_RAW_IMU)} ~ {(RangeMax.xgyro_RAW_IMU)}</span>
                        </div>
                        <div className={`flex flex-col justify-around  mr-4 w-full h-full rounded-md bg-${ColorThema.Secondary2}`}>
                            <span className="ml-5">Y축</span>
                            <span className={`mx-auto font-extrabold text-2xl ${WarningData.ygyro_RAW_IMU?`text-${ColorThema.Semantic3}`:'text-[#FFFF00]'}`}>{(SensorData.ygyro_RAW_IMU)}</span>
                        ...
                        <div className={`flex flex-col justify-around w-full  h-full rounded-md bg-${ColorThema.Secondary2}`}>
                            ...
                            <span className={`mx-auto font-extrabold text-2xl ${WarningData.zgyro_RAW_IMU?`text-${ColorThema.Semantic3}`:'text-[#FFFF00]'}`}>{(SensorData.zgyro_RAW_IMU)}</span>
                ...
                <div className={`flex flex-col w-full h-full p-3 rounded-2xl bg-${ColorThema.Secondary4}`}>
                    ...
                    <div className="flex flex-row justify-around h-full p-5">
                        <div className={`flex flex-col justify-around mr-4 w-full  h-full rounded-md bg-${ColorThema.Secondary2}`}>
                            <span className="ml-5">X축</span>
                            <span className={`mx-auto font-extrabold text-2xl ${WarningData.xmag_RAW_IMU?`text-${ColorThema.Semantic3}`:'text-[#FFFF00]'}`}>{(SensorData.xmag_RAW_IMU)}</span>
                            <span className="mx-auto">{(RangeMin.xmag_RAW_IMU)} ~ {(RangeMax.xmag_RAW_IMU)}</span>
                        </div>
                        <div className={`flex flex-col justify-around  mr-4 w-full h-full rounded-md bg-${ColorThema.Secondary2}`}>
                            <span className="ml-5">Y축</span>
                            <span className={`mx-auto font-extrabold text-2xl ${WarningData.ymag_RAW_IMU?`text-${ColorThema.Semantic3}`:'text-[#FFFF00]'}`}>{(SensorData.ymag_RAW_IMU)}</span>
                            <span className="mx-auto">{(RangeMin.ymag_RAW_IMU)} ~ {(RangeMax.ymag_RAW_IMU)}</span>
                        </div>
                        <div className={`flex flex-col justify-around w-full  h-full rounded-md bg-${ColorThema.Secondary2}`}>
                            <span className="ml-5">Z축</span>
                            <span className={`mx-auto font-extrabold text-2xl ${WarningData.zmag_RAW_IMU?`text-${ColorThema.Semantic3}`:'text-[#FFFF00]'}`}>{(SensorData.zmag_RAW_IMU)}</span>
...
const RealTimeBoardSide = (props) => {
    ...
    return (
        <div className={`flex flex-col w-[38%] h-full p-3 mr-4 rounded-2xl bg-${ColorThema.Secondary4}`}>
            <span className="text-white rounded-md ml-3 font-bold text-medium">• 기체 자세 </span>
            <div className="flex flex-col justify-center h-full ">
                <div className={`flex flex-col justify-around m-5  h-full rounded-md bg-${ColorThema.Secondary2}`}>
                    <span className="ml-5">Roll</span>
                    <span
                        className={`mx-auto font-extrabold text-2xl ${WarningData.roll_ATTITUDE ? `text-${ColorThema.Semantic3}` : 'text-[#FFFF00]'}`}>{(SensorData.roll_ATTITUDE)}</span>
                ...
                <div className={`flex flex-col justify-around m-5  h-full rounded-md bg-${ColorThema.Secondary2}`}>
                    ...
                    <span
                        className={`mx-auto font-extrabold text-2xl ${WarningData.pitch_ATTITUDE ? `text-${ColorThema.Semantic3}` : 'text-[#FFFF00]'}`}>{(SensorData.pitch_ATTITUDE)}</span>
                ...
                <div className={`flex flex-col justify-around m-5  h-full rounded-md bg-${ColorThema.Secondary2}`}>
                    ...
                    <span
                        className={`mx-auto font-extrabold text-2xl ${WarningData.yaw_ATTITUDE ? `text-${ColorThema.Semantic3}` : 'text-[#FFFF00]'}`}>{(SensorData.yaw_ATTITUDE)}</span>
