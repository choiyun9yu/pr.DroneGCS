            ...
            <motion.div animate={controls} className={`flex flex-col justify-between rounded-r-3xl shadow-xl shadow-black ${ColorThema.Secondary4}`}>
                <div className="flex flex-col mt-5 ml-5">
                    <button onClick={isOpen ? showLess : showMore}
                            className={`flex items-center w-[48px] h-[40px]  hover:bg-[#6359E9] rounded-md mt-5 text-white ${ColorThema.Secondary3}`}>
                        <svg
                    ...
                    <motion.ul>
                        {MenuIcon.mainMenu.map((item, index) => (
                            <li className={`flex items-center mr-3 h-[40px] rounded-md mt-7 text-white ${ColorThema.Secondary3} hover:${ColorThema.Primary1}`} key={index}>
                ...
                <div className="flex flex-col mt-5 ml-5 mb-40">
                    <ul>
                        <li className={`flex items-center mr-3 h-[40px] rounded-md mt-7 text-white ${ColorThema.Secondary3} hover:${ColorThema.Primary1}`}>
