...
[DataContract] public struct DroneMessageInterface
{
    [DataMember] public string? DroneId;
    [DataMember] public List<MavlinkLog> DroneLogger;
...
[DataContract] public struct MavlinkLog
{
    [DataMember] public DateTime logtime;
    [DataMember] public string message;
}

[DataContract] public class DroneStt
{
    [DataMember] public double? WayPointNum;
    [DataMember] public double? PowerV;
    [DataMember] public double? BatteryStt;
    ...
    [DataMember] public CustomMode? FlightMode;
...
[DataContract] public class DroneTrack
{
    ...
    [DataMember] public FixedSizedQueue<CurrentGisLocation> DroneTrails = new(600);
...
[DataContract] public class SensorData
{
    [DataMember] public double roll_ATTITUDE;
    [DataMember] public double pitch_ATTITUDE;
    [DataMember] public double yaw_ATTITUDE;
