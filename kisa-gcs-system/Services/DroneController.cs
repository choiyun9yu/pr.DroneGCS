...
public class DroneController : Hub<IDroneHub>
{
    ...
    public async Task HandleMavlinkMessage(MAVLink.MAVLinkMessage msg, DroneCommunication link, IChannelHandlerContext ctx, IPEndPoint droneAddress)
    {
     ...
     public async Task SetCustomModeAsync(MAVLink.MAVLinkMessage msg)
     {
     ...
     private DatagramPacket EncodeUdpDroneMessage(MAVLink.MAVLinkMessage msg)
     {
         ...
         Console.WriteLine("Send Message to Drone");
